...
var HotReload = (function () {
    ...
    HotReload.prototype.hotWatch = function (type, filename) {
        var mode = type === 'rename' ? fs_1.default.existsSync(filename) ? 'created' : 'remove' : type;
        switch (mode) {
            case 'created':
    ...
    HotReload.prototype.reload = function (id, reloadeds) {
        ...
        try {
            ...
            mod.hot = mod.hot || hot;
            mod.parent = parent;
            var finded = module.children.find(function (m) { return m.filename === id; });
